...
exports.sendotp = async (req, res) => {
    try {
        ...
        const otpPayload = { email, otp, expiresAt: otpExpires };
        const otpBody = await OTP.create(otpPayload);

        // Send OTP to the user's email
        const otpContent = `Your OTP is: ${otp}. It will expire in 10 minutes.`;
        try {
            const emailResponse = await mailSender(email, otpContent);
